...
Feature: Academy Choucair
  ...
  Scenario: Register on the Utest site
    ...
    When start the registration process in Utest
      ...
      | Joel David | Rochel Hernandez | joelrochel108@gmail.com | August   | 24     | 1998    | Spanish         | Cereté    | 230550    | Colombia    | Windows     | Windows 10 | Spanish     | Xiaomi    | Redmi Note 8 | Android 11 | 123@PassReto |
