...
public class UtestStepDefinitions {
    ...
    public void joelWantsToRegisterOnTheUtestSite() {
        OnStage.theActorCalled("Joel").wasAbleTo(OpenUp.thePage(), Register.onThePage());
    }


    @When("^start the registration process in Utest$")
    public void startTheRegistrationProcessInUtest(List<UtestData> data) {
        OnStage.theActorInTheSpotlight().attemptsTo(FillOutThePersonalData.onThePage(data), FillOutTheLocationData.onThePage(data),
